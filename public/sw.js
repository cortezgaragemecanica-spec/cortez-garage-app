const CACHE='cortez-garage-v56',ROOT=new URL('./',self.location).pathname,ASSETS=['./','./index.html','./src/style.css?v=20260828-11','./src/checklist.css?v=20260829-3','./src/main.js?v=20260828-11','./src/sync.js','./src/supabase.js','./src/image-utils.js','./src/delete-order.js?v=20260828-11','./src/budget-order.js?v=20260828-11','./src/pdf-order.js?v=20260828-11','./src/stock.js?v=20260828-11','./src/admin.js?v=20260828-11','./src/reports.js?v=20260828-11','./manifest.webmanifest','./official-logo.png','./icons/icon-192.png','./icons/icon-512.png'];
