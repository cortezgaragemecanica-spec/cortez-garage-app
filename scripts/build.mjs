...
const required=['index.html','src/main.js','src/sync.js','src/style.css','public/sw.js','public/manifest.webmanifest','public/official-logo.png','public/icons/icon-192.png','public/icons/icon-512.png'];
